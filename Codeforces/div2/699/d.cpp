...
void solve() {
  ...
  vvi toA(n), toB(n), fromA(n), fromB(n);
  rep(i, 0, n) {
    rep(j, 0, n) {
      if (j == i) continue;
      if (graph[i][j] == 'a') {
  ...
  int p1, p2, p3;
  rep(i, 0, n) {
    if (!(fromA[i].empty()) && !(fromB[i].empty())) {
      p1 = i;
      p2 = fromA[i][0];
      p3 = fromB[i][0];
      break;
  ...
  cout << "YES" << endl;
  if (m == 2) {
    cout << p2+1 << " " << p1+1 << " " << p3+1 << endl;
  } else if (m % 4 == 0) {
    rep(i, 0, m/4) {
      cout << p1+1 << " " << p2+1 << " " << p1+1 << " " << p3+1 << " ";
    }
    cout << p1+1 << endl;
  } else {
    m -= 6;
    if (graph[p2][p3] == 'a') {
      ...
      cout << p1+1 << " " << p3+1 << " " << p1+1 << " " << p3+1 << endl;
    } else {
      cout << p3+1 << " " << p2+1 << " " << p3+1 << " ";
      rep(i, 0, m/4) {
        cout << p1+1 << " " << p2+1 << " " << p1+1 << " " << p3+1 << " ";
      }
      cout << p1+1 << " " << p2+1 << " " << p3+1 << " " << p2+1 << endl;
    }
  }
}
