...
bool lessA(const P &p1, const P &p2) { return p1.a < p2.a; };
bool lessB(const P &p1, const P &p2) { return p1.b < p2.b; };
...
int main() {
  ...
  if (N&1) {
    ...
    int ma1 = V[N/2].b, ma2 = V[N/2-1].b;
    sort(All(V), lessA);
    int mi1 = V[N/2].a, mi2 = V[N/2-1].a;
    int ma = ma1+ma2;
    int mi = mi1+mi2;
    ans = max(1, ma-mi+1);
  }
